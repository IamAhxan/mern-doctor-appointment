            ...
            <div className='flex flex-col gap-3 m-auto items-start p-8 min-w-[340px] sm:min-w-96 border rounded-xl text-zinc-600 text-sm shadow-lg'>
                ...
                <p>Please {state === 'Sign Up' ? "sign up" : 'login'} to book an appointment</p>
                {
                    ...
                    <div className='w-full'>
                        <p>Full Name</p>
                        <input required className='border border-zinc-300 rounded w-full p-2 mt-1' type="text" onChange={(e) => { setName(e.target.value); console.log(e.target.value) }} value={name} />
                    </div>
                }
                ...
                <button type='submit' className='cursor-pointer bg-primary text-white w-full py-2 rounded-md text-base'>{state === 'Sign Up' ? "Create Account" : "Login"}</button>
                {
                    state === 'Sign Up'
